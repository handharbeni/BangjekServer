<form id="form1" action="<?php echo $config->base_url();?>update_room_chat.html" method="post" onsubmit="return check(this.action);">
...
<table>
	<tr>
		...
		<td>
			...
			<?php foreach($show_transaksi as $key=>$show){?>
				...
				<option value="<?php echo $show['id_transaksi'];?>" <?php if($id_transaksi == $show['id_transaksi']){echo "selected";}?>><?php echo $show['status'];?></option>
	...
	<tr>
		...
		<td>
			...
			<?php foreach($show_pelanggan as $key=>$show){?>
				...
				<option value="<?php echo $show['id_pelanggan'];?>" <?php if($id_pelanggan == $show['id_pelanggan']){echo "selected";}?>><?php echo $show['nama'];?></option>
	...
	<tr>
		...
		<td>
			...
			<?php foreach($show_merchant as $key=>$show){?>
				...
				<option value="<?php echo $show['id_merchant'];?>" <?php if($id_merchant == $show['id_merchant']){echo "selected";}?>><?php echo $show['name'];?></option>
	...
	<tr>
		...
		<td valign="top">:</td>
		<td>
			<textarea name="isi_chat" placeholder="Isi Chat"><?php echo $isi_chat;?></textarea>
		</td>
	</tr>
	<tr>
