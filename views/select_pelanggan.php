<form id="form1" action="<?php echo $config->base_url();?>update_pelanggan.html" method="post" onsubmit="return check(this.action);">
...
<table>
	...
	<tr>
		...
		<td valign="top">:</td>
		<td>
			<input type="number" name="saldo" placeholder="Saldo" value="<?php echo $saldo;?>">
		</td>
	</tr>
	<tr>
