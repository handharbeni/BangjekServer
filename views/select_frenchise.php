<form id="form1" action="<?php echo $config->base_url();?>update_frenchise.html" method="post" onsubmit="return check(this.action);">
...
<table>
	...
	<tr>
		...
		<td valign="top">:</td>
		<td>
			<input type="text" name="npwp" placeholder="Npwp" value="<?php echo $npwp;?>">
		</td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td valign="top">:</td>
		<td>
			<input type="text" name="latitude" placeholder="Latitude" value="<?php echo $latitude;?>">
		</td>
	</tr>
	<tr>
		...
		<td valign="top">:</td>
		<td>
			<input type="text" name="longitude" placeholder="Longitude" value="<?php echo $longitude;?>">
		</td>
	</tr>
	<tr>
		...
		<td valign="top">:</td>
		<td>
			<input type="text" name="luas" placeholder="Luas" value="<?php echo $luas;?>">
		</td>
	</tr>
	<tr>
