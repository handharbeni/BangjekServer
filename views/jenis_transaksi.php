<table id="show" border="1" cellspacing="0" cellpadding="5">
	<tr>
		...
		<th width="50">No</th>
		<th>
			<form action="<?php echo $config->base_url();?>jenis_transaksi.html" method="post">
				...
				<input type="submit" value="Nama Jenis" />
			</form>
		</th>
	</tr>
	...
	<tr <?php if($zebra%2==1){echo "class='normal zebra'";}else{echo "class='normal'";}?>>
		<td align=center valign="top"><a href="<?php echo $config->base_url();?>select_jenis_transaksi/<?php echo $tampil['id_jenis_transaksi'];?>.html" class="ubah"><img src="<?php echo $config->base_url();?>images/edit.png" class="tools"></a></td>
		...
		<a href="<?php echo $config->base_url();?>delete_jenis_transaksi/<?php echo $tampil['id_jenis_transaksi'];?>.html" onclick="return confirm('Delete <?php echo $tampil['nama_jenis'];?>?');"><img src="<?php echo $config->base_url();?>images/delete.png" class="tools"></a>
	...
	<table id="pagination" cellspacing="0">
		<tr>
			...
			<td>
				Field : 
				<select name="field">
					<option value="nama_jenis" <?php if($field=="nama_jenis"){echo "selected";}?>>Nama Jenis</option>
				</select>
