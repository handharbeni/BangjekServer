<form id="form1" action="<?php echo $config->base_url();?>insert_tarif.html" method="post" onsubmit="return check(this.action);">
<table>
	<tr>
		...
		<td>
			...
			<?php foreach($show_global_setting as $key=>$show){?>
				...
				<option value="<?php echo $show['id_global_setting'];?>"><?php echo $show['nama_setting'];?></option>
	...
	<tr>
		...
		<td>
			...
			<?php foreach($show_frenchise as $key=>$show){?>
				...
				<option value="<?php echo $show['id_frenchise'];?>"><?php echo $show['nama'];?></option>
