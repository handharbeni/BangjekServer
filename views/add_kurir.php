<form id="form1" action="<?php echo $config->base_url();?>insert_kurir.html" method="post" onsubmit="return check(this.action);">
<table>
	<tr>
	...
	<tr>
		...
		<td valign="top">:</td>
		<td>
			<input type="text" name="jaminan" placeholder="Jaminan">
		</td>
	</tr>
	<tr>
