<form id="form1" action="<?php echo $config->base_url();?>update_staff.html" method="post" onsubmit="return check(this.action);">
...
<table>
	<tr>
		...
		<td>
			<input type="text" name="user_staff" placeholder="Username" value="<?php echo $user_staff;?>">
		</td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td>
			...
			?>
				...
				<option value="<?php echo $show['id_level'];?>" <?php if($id_level == $show['id_level']){echo "selected";}?>><?php echo $show['nama_level'];?></option>
