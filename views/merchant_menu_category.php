<table id="show" border="1" cellspacing="0" cellpadding="5">
	<tr>
		...
		<th width="50">No</th>
		<th>
			<form action="<?php echo $config->base_url();?>merchant_menu_category.html" method="post">
	...
	<tr <?php if($zebra%2==1){echo "class='normal zebra'";}else{echo "class='normal'";}?>>
		<td align=center valign="top"><a href="<?php echo $config->base_url();?>select_merchant_menu_category/<?php echo $tampil['id_merchant_menu_category'];?>.html" class="ubah"><img src="<?php echo $config->base_url();?>images/edit.png" class="tools"></a></td>
		<td align=center valign="top"><a href="<?php echo $config->base_url();?>delete_merchant_menu_category/<?php echo $tampil['id_merchant_menu_category'];?>.html" onclick="return confirm('Delete <?php echo $tampil['merchant_menu_category'];?>?');"><img src="<?php echo $config->base_url();?>images/delete.png" class="tools"></a></td>
