<form id="form1" action="<?php echo $config->base_url();?>update_merchant_menu.html" method="post" onsubmit="return check(this.action);">
...
<table>
	<tr>
		...
		<td>
			<input type="text" name="merchant_menu" placeholder="Merchant Menu" value="<?php echo $merchant_menu;?>">
		</td>
	</tr>
	<tr>
		...
		<td>
			...
			<?php foreach($show_merchant_menu_category as $key=>$show){?>
				...
				<option value="<?php echo $show['id_merchant_menu_category'];?>" <?php if($id_merchant_menu_category == $show['id_merchant_menu_category']){echo "selected";}?>><?php echo $show['merchant_menu_category'];?></option>
	...
	<tr>
		...
		<td valign="top">:</td>
		<td>
			<input type="number" name="discount" placeholder="Discount" value="<?php echo $discount;?>">
		</td>
	</tr>
	<tr>
		...
		<td>
			<select name="discount_variant">
				<option value="0" <?php if($discount_variant==0){echo "Selected";}?>>Percent (%)</option>
				<option value="1" <?php if($discount_variant==1){echo "Selected";}?>>Value</option>
			</select>
		</td>
	</tr>
	<tr>
