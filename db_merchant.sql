...
REPLACE INTO `merchant` (`id_merchant`, `name`, `address`, `email`, `password`, `phone`, `photo`, `latitude`, `longitude`, `description`, `id_merchant_category`, `max_upload`, `open_at`, `close_at`, `point`, `open_status`, `join_at`, `status`, `deleted`, `imei1`, `imei2`, `key`, `sha`) VALUES
...
REPLACE INTO `merchant_category` (`id_merchant_category`, `merchant_category`, `max_upload`, `date_add`, `status`, `deleted`, `sha`) VALUES
...
DROP TABLE IF EXISTS `merchant_menu`;
...
REPLACE INTO `merchant_menu` (`id_merchant_menu`, `id_merchant`, `merchant_menu`, `id_merchant_menu_category`, `photo`, `price`, `discount`, `discount_variant`, `description`, `date_add`, `status`, `deleted`, `sha`) VALUES
...
DROP TABLE IF EXISTS `merchant_menu_category`;
...
REPLACE INTO `merchant_menu_category` (`id_merchant_menu_category`, `merchant_menu_category`, `date_add`, `status`, `deleted`, `sha`) VALUES
...
DROP TRIGGER IF EXISTS `merchant_before_update`;
SET @OLDTMP_SQL_MODE=@@SQL_MODE, SQL_MODE='';
DELIMITER //
CREATE TRIGGER `merchant_before_update` BEFORE UPDATE ON `merchant` FOR EACH ROW BEGIN
	...
	SET @sha = CONCAT("-", @name, @address, @email, @password, @description,
											@phone, @photo, @latitude, @longitude, 
											@id_merchant_category, @max_upload, @open_at, 
											@close_at, @open_status,
											@status, @deleted, @IMEI1, @IMEI2);
...
DROP TRIGGER IF EXISTS `merchant_category_before_insert`;
SET @OLDTMP_SQL_MODE=@@SQL_MODE, SQL_MODE='';
DELIMITER //
...
DROP TRIGGER IF EXISTS `merchant_category_before_update`;
SET @OLDTMP_SQL_MODE=@@SQL_MODE, SQL_MODE='';
DELIMITER //
...
DROP TRIGGER IF EXISTS `merchant_menu_before_insert`;
SET @OLDTMP_SQL_MODE=@@SQL_MODE, SQL_MODE='';
DELIMITER //
...
DROP TRIGGER IF EXISTS `merchant_menu_before_update`;
SET @OLDTMP_SQL_MODE=@@SQL_MODE, SQL_MODE='';
DELIMITER //
...
DROP TRIGGER IF EXISTS `merchant_menu_category_before_insert`;
SET @OLDTMP_SQL_MODE=@@SQL_MODE, SQL_MODE='';
DELIMITER //
...
DROP TRIGGER IF EXISTS `merchant_menu_category_before_update`;
SET @OLDTMP_SQL_MODE=@@SQL_MODE, SQL_MODE='';
DELIMITER //
